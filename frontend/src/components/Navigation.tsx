  ...
  return (
    <section className="py-20 px-6">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-4xl md:text-5xl font-orbitron font-bold text-center mb-16 text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">
            ...
            >
              <div className="relative bg-gray-900 rounded-2xl p-8 h-full hover:bg-gray-800/90 transition-all duration-300">
                <div className="flex items-center justify-between">
                  ...
                  <ChevronRight 
                    className="text-orange-500 group-hover:translate-x-2 group-hover:scale-110 transition-all duration-300" 
                    size={24} 
                  />
                </div>
